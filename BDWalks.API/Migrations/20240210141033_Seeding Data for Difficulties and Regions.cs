    ...
    public partial class SeedingDataforDifficultiesandRegions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0b50f70f-728c-4a4a-a76b-7a53817e60d3"), "Easy" },
                    { new Guid("461310ad-9d1b-439d-93ec-f0f66c22ffb1"), "Hard" },
                    { new Guid("ec0c9edc-1084-44e0-a328-9a3a5353aa0f"), "Medium" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("0b50f70f-728c-4a4a-a76b-7a53817e60d3"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("461310ad-9d1b-439d-93ec-f0f66c22ffb1"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("ec0c9edc-1084-44e0-a328-9a3a5353aa0f"));
